...
namespace QuickPay.Models.Shared
{
    public class Metadata
    {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "corporate", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = "is_3d_secure", NullValueHandling = NullValueHandling.Ignore)]
